...
Typically this course has a high drop, fail, withdraw rate (DFW).  This course is also one of the first programming classes taken by transfer students.  The goal of the intervention is to increase student engagement and to reduce the DFW rate.  
