...
%% mention we didn't create plickers (fairly sure this is in there...)
...
%% Are students uncomfortable with their photos taken in the plicker

%% Add demo data if possible
